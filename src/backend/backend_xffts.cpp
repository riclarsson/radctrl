#include "backend_xffts.h"


namespace Instrument::Spectrometer {
XFFTS::XFFTS(const std::string &n, const std::filesystem::path &path)
...
void XFFTS::startup(const std::string &host, int tcp, int udp,
