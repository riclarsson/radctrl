#include "backend_dffts.h"

namespace Instrument::Spectrometer {
dFFTS::dFFTS(const std::string &n, const std::filesystem::path &path)
...
void dFFTS::startup(const std::string &host, int tcp, int udp,
