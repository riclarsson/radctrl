#include "backend_swicts.h"

namespace Instrument::Spectrometer {
SWICTS::SWICTS(const std::string &n, const std::filesystem::path &path)
...
void SWICTS::startup(const std::string &host, int tcp, int udp,
