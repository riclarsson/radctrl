#include "backend_pc104.h"

namespace Instrument::Spectrometer {
PC104::PC104(const std::string &n, const std::filesystem::path &path)
...
void PC104::startup(const std::string &host, int tcp, int udp,
