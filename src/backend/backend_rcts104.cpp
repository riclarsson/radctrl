#include "backend_rcts104.h"

namespace Instrument::Spectrometer {
RCTS104::RCTS104(const std::string &n, const std::filesystem::path &path)
...
void RCTS104::startup(const std::string &host, int tcp, int udp,
