...
class Number {
  ...
  Rational value;
public:
  constexpr Number() noexcept : text({' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '}), istext(false), value(rational_undefined()) {}
  constexpr Number(std::array<char, Number::N> t) noexcept : text(t), istext(true), value(rational_undefined()) {}
  constexpr Number(Rational v) noexcept : text({' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '}), istext(false), value(v) {}
  Number(const std::string& val) noexcept : text({' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '}), istext(false), value(rational_undefined()) {
  ...
  constexpr bool operator==(Number n) const noexcept {if (n.istext != istext) return false; else if (istext) return n.text==text; else return n.value==value;}
