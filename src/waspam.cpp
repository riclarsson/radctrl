...
int main (int argc, char * argv[]) try {
  ...
  File::ConfigParser parser(argv[1], {"Chopper", "Wobbler", "Housekeeping", "Frontend", "Backends", "Operations", "Savepath"});
  GUI::Config config;
  ...
  Instrument::Housekeeping::Agilent hk{parser("Housekeeping", "path")};
  ...
  int integration_time_microseconds = std::stoi(parser("Operations", "integration_time"));
  ...
  std::array<Instrument::Spectrometer::Controller, backends.N> backend_ctrls{
    Instrument::Spectrometer::Controller(parser("Backends", "spectormeter1"), 
                                         parser("Backends", "config1"),
                                         integration_time_microseconds,
                                         blank_time_microseconds)
  };
