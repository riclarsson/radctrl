...
int run(const File::ConfigParser& parser) try {
  ...
  std::vector<GUI::Plotting::CAHA76> backend_frames{GUI::Plotting::CAHA76{spectrometer_ctrls.backends[0].name, spectrometer_ctrls.backends[0].f}};
