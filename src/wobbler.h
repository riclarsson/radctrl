...
void GuiSetup(Wobbler &wob, Controller<N> &ctrl,
  ...
  for (size_t i = 0; i < N; i += 4) {
    if (N - i > 3) {
      std::string label = std::string{"Items "} + std::to_string(i) +
                          std::string{"-"} + std::to_string(i + 3);
      ImGui::InputInt4(label.c_str(), &ctrl.pos[i],
                       ImGuiInputTextFlags_CharsDecimal |
                           ImGuiInputTextFlags_CharsNoBlank |
                           ImGuiInputTextFlags_NoHorizontalScroll |
                           ImGuiInputTextFlags_AutoSelectAll);
      ...
      std::string label = std::string{"Items "} + std::to_string(i) +
                          std::string{"-"} + std::to_string(i + 2);
      ImGui::InputInt3(label.c_str(), &ctrl.pos[i],
                       ImGuiInputTextFlags_CharsDecimal |
                           ImGuiInputTextFlags_CharsNoBlank |
                           ImGuiInputTextFlags_NoHorizontalScroll |
                           ImGuiInputTextFlags_AutoSelectAll);
      ...
      ImGui::InputInt2(label.c_str(), &ctrl.pos[i],
                       ImGuiInputTextFlags_CharsDecimal |
                           ImGuiInputTextFlags_CharsNoBlank |
                           ImGuiInputTextFlags_NoHorizontalScroll |
                           ImGuiInputTextFlags_AutoSelectAll);
      ...
      ImGui::InputInt(label.c_str(), &ctrl.pos[i], 1, 100,
                      ImGuiInputTextFlags_CharsDecimal |
                          ImGuiInputTextFlags_CharsNoBlank |
                          ImGuiInputTextFlags_NoHorizontalScroll |
                          ImGuiInputTextFlags_AutoSelectAll);
