...
int main() try {
  ...
  Method::abs_speciesSet(
      ws, ArrayOfString{"PH3", "SO2", "CO2", "CO", "HCl", "HF", "N2", "O", "O2",
                        "OCS", "SO", "H2O", "N2-CIA-N2-0", "CO2-CIA-CO2-0"});
  Var::nelem(ws) = 501;
  ...
  Method::AtmRawRead(ws, String{"/home/larsson/Work/arts-xml-data/planets/"
                                "Venus/MPS/Venus.vira.day/Venus.vira.day"});
  Method::ReadXML(ws, Var::abs_cia_data(ws),
                  String{"/home/larsson/Work/arts-xml-data/spectroscopy/cia/"
  ...
  Method::ReadXML(ws, Var::partition_functions(ws),
                  String{"/home/larsson/Work/arts-xml-data/spectroscopy/"
                         "PartitionSums/TIPS/tips.xml"});
  Method::ReadXML(ws, Var::isotopologue_ratios(ws),
                  String{"/home/larsson/Work/arts-xml-data/planets/Venus/"
                         "isotopratio_Venus.xml"});
  Method::ReadARTSCAT(
      ws,
      String{
          "/home/larsson/Work/arts-xml-data/spectroscopy/Perrin/PH3.xml.gz"});
  Method::abs_linesDeleteBadF0(ws, 400e9);
  Method::abs_linesDeleteBadF0(ws, 1300e9, 0);
  const auto phoscat = Var::abs_lines(ws);
  Method::ReadSplitARTSCAT(
      ws, String{"/home/larsson/Work/arts-xml-data/spectroscopy/Perrin/"},
      400e9, 1300e9);
  ...
  for (auto& line : phoscat.value()[0].AllLines()) {
    if (line.F0() < 500e9 or line.F0() > 1200e9 or
        (line.F0() < 1000e9 and line.F0() > 650e9))
      continue;

    Var::nelem(ws) = 1001;
    Method::VectorNLinSpace(ws, Var::f_grid(ws), line.F0() - 500e9,
                            line.F0() + 500e9);
