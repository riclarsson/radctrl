...
struct Zeeman {
  ...
  friend std::ostream& operator<<(std::ostream& os, Zeeman z) {return os << z.gu << ' ' << z.gl;}
  friend std::istream& operator>>(std::istream& os, Zeeman& z) {return os >> z.gu >> z.gl;}
  ...
  /** Gives the lowest M for a polarization type of this transition
    ...
    */
  static constexpr Rational start(Rational Ju, Rational Jl, Polarization type) noexcept {
    switch (type) {
      case Polarization::SigmaMinus:
        if (Ju < Jl)
          return -Ju;
  ...
  /** Gives the largest M for a polarization type of this transition
    ...
    */
  static constexpr Rational end(Rational Ju, Rational Jl, Polarization type) noexcept {
    switch (type) {
      case Polarization::SigmaMinus:
        return Ju + 1;
      case Polarization::Pi:
  ...
  /** Gives the upper state M value at an index
    ...
    */
  static constexpr Rational Mu(Rational Ju,
                               Rational Jl,
                               Polarization type,
                               int n) noexcept {
  ...
  /** Gives the lower state M value at an index
    ...
    */
  static constexpr Rational Ml(Rational Ju,
                               Rational Jl,
                               Polarization type,
                               int n) noexcept {
  ...
  /** Gives the splitting of one subline of a given polarization
    ...
    */
  constexpr double Splitting(Rational Ju, Rational Jl, Polarization type, int n) const
  noexcept {
