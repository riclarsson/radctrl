...
void test001() {
  int x;
  double y;
  File::File<File::Operation::Write, File::Type::Raw> w("test_file_test001.rawtext");
  w << "1";
  w.close();
  File::File<File::Operation::Append, File::Type::Raw> a("test_file_test001.rawtext");
  a << "2";
  a.close();
  File::File<File::Operation::Read, File::Type::Raw> r("test_file_test001.rawtext");
  r >> x;
  r.close();
  File::File<File::Operation::Read, File::Type::Raw> r2("test_file_test001.rawtext");
  r2 >> y;
  r2.close();
  std::cout<<"write: "<<1<<2<<'\n';
...
void test002() {
  ...
  File::File<File::Operation::WriteBinary, File::Type::Raw> w("test_file_test002.rawbin");
  w.write(int(12));
  w.close();
  File::File<File::Operation::AppendBinary, File::Type::Raw> a("test_file_test002.rawbin");
  a.write(double(12+1.0/3));
  a.close();
  File::File<File::Operation::ReadBinary, File::Type::Raw> r("test_file_test002.rawbin");
  r.read(x);
  r.close();
  File::File<File::Operation::ReadBinary, File::Type::Raw> r2("test_file_test002.rawbin");
  r2.seek(sizeof(int));
  r2.read(y);
  r2.close();
  File::File<File::Operation::ReadBinary, File::Type::Raw> r3("test_file_test002.rawbin");
...
void test003() {
  ...
  File::File<File::Operation::WriteBinary, File::Type::Raw> w("test_file_test003.rawbin");
  w.write(x);
  w.write(z);
  w.close();
  File::File<File::Operation::ReadBinary, File::Type::Raw> r("test_file_test003.rawbin");
  r.read(y);
  r.read(p);
  r.close();
...
void test004() {
  File::File<File::Operation::Write, File::Type::Xml> w("test_file_test004.xml");
  w.new_child("MyChild");
  ...
  std::cout << std::boolalpha <<"read attribute 'Born': " << c.attribute("Born").as_bool() << '\n';
...
void test005() {
  File::File<File::Operation::Write, File::Type::Xml> w("test_file_test005.xml");
  w.new_child("MyChild");
  w.add_attribute("Scream", "I am here");
  w.add_attribute("Born", false);
  w.add_attribute("Age", 0);
  ...
  File::File<File::Operation::Append, File::Type::Xml> a("test_file_test005.xml");
  a.get_child("MyChild");
  a << 5.55555555555555555555555 << '\n';
  a.close();
  
  y.resize(3);
  File::File<File::Operation::Read, File::Type::Xml> r2("test_file_test005.xml");
...
void test006() {
  File::File<File::Operation::WriteBinary, File::Type::Xml> w("test_file_test006.xml");
  w.new_child("MyChild");
  w.add_attribute("Scream", "I am here");
  w.add_attribute("Born", false);
  w.add_attribute("Age", 0);
  ...
  File::File<File::Operation::AppendBinary, File::Type::Xml> a("test_file_test006.xml");
  a.get_child("MyChild");
  a.write(int(2));
  std::cout<<"append data (int): " << 2 << '\n';
  a.close();
  
  File::File<File::Operation::ReadBinary, File::Type::Xml> r("test_file_test006.xml");
  auto c = r.get_child("MyChild");
  std::cout<<"read attribute 'Scream': " << c.attribute("Scream").as_string() << '\n';
  std::cout<<"read attribute 'Age': " << c.attribute("Age").as_int() << '\n';
  std::cout << std::boolalpha <<"read attribute 'Born': " << c.attribute("Born").as_bool() << '\n';
...
void test007() {
  File::File<File::Operation::WriteBinary, File::Type::Xml> w("test_file_test007.xml");
  w.new_child("MyChild");
  w.add_attribute("Scream", "I am here");
  w.add_attribute("Born", false);
  w.add_attribute("Age", 0);
  ...
  File::File<File::Operation::AppendBinary, File::Type::Xml> a("test_file_test007.xml");
  a.get_child("MyChild");
  ...
  File::File<File::Operation::ReadBinary, File::Type::Xml> r("test_file_test007.xml");
  auto c = r.get_child("MyChild");
  std::cout<<"read attribute 'Scream': " << c.attribute("Scream").as_string() << '\n';
  std::cout<<"read attribute 'Age': " << c.attribute("Age").as_int() << '\n';
  std::cout << std::boolalpha <<"read attribute 'Born': " << c.attribute("Born").as_bool() << '\n';
