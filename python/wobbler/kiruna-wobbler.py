...
class wobbler:
	def __init__(self,device='/dev/ttyUSB1',baud=115200, address="None"):
	...
	def init(self,position,frequency=1000):
	...
	def _wait(self, timeout=0):
		...
		self._read()
		assert self._pos==self._getPosition(), "Wobbler position not accurate, {} requested, {} performed".format(self._pos, self._getPosition())
